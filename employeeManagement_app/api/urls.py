...
urlpatterns = [
    ...
    path('deductionEligibility/list/', views.DeductionEligibility_list.as_view(), name='DeductionEligibility_list'),
    path('deductionEligibility/<int:pk>/', views.DeductionEligibility_details.as_view(), name='DeductionEligibility_details'),
    ...
    path('compensationEligibility/list/', views.CompensationEligibility_list.as_view()),
    path('compensationEligibility/<int:pk>/', views.CompensationEligibility_details.as_view()),
